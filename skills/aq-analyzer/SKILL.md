...
2. **Open your Claude Acquisition Engine Project.** Make sure the AQ Score criteria file is uploaded to Project Knowledge (see claude-acquisition-setup skill). If not, paste the 13 criteria into the chat: location, seller finance, broker, long listing, margin, history, FF&E, multiple, leased space, own property, staff, inventory, training.
   ...
   **The rating legend (use this, not an invented one).** Green = confirmed favorable, yellow = unknown / not yet disclosed (an information gap to close, not a no), red = confirmed unfavorable. Three criteria run opposite to instinct, per Frasier's own scoring: **long listing** — LONGER time on market is green (a more motivated, more negotiable seller), not stale inventory; **broker** — direct/off-market is the preferred green (a broker listing is yellow-to-neutral: packaged info but an intermediary and anchored pricing); **own property** — real estate owned is green (cash flow + collateral), though Frasier often prefers deals *without* real estate to keep the deal simple. The usual green anchors for the rest: seller financing offered, profitable margin, 10+ years history, real FF&E, asking multiple within the fair band, transferable lease, team that stays, clean inventory, transition/training offered.
