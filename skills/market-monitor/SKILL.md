...
2. **Open Claude and start a chat in your Acquisition Engine Project.** Confirm your buy box is uploaded to Project Knowledge. If not, paste your criteria: geography (Orange County CA), revenue ($1-5M), SDE ($200K+), verticals (hood cleaning, water purification, laundromats, pool service, etc.).

3. **Ask Claude to web search for new listings in your top 3 verticals.** Use this prompt pattern: "Web search BizBuySell, BizQuest, and California business brokers for listings in these verticals: kitchen hood cleaning, pool service, laundromats. Filter to Orange County or San Diego. Revenue $1-5M preferred. Return a table: business name (or description if name not disclosed), city, revenue, asking price, SDE if disclosed, days listed, source (BizBuySell/broker name). Limit to listings posted in the last 30 days."
