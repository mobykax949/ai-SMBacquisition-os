...
2. **Write your buy box criteria as a markdown file.** Save it as `buy-box.md` on your desktop. Include: geography (Orange County CA), revenue ($1M-$5M), SDE ($200K+), employees (5-25), age (10+ years, founded pre-2015), owner profile (boomer 55+, exit-minded), financing (SBA 7(a) + seller note or 1031 if real estate), and your priority verticals (hood cleaning, water purification, laundromats, landscape, pool, car wash, etc.). Keep it under 2 pages.
...
4. **Add the 13-criterion AQ Score as Project Knowledge.** Create `aq-score.md` with the 13 criteria: location, seller finance, broker, long listing, margin, history, FF&E, multiple, leased space, own property, staff, inventory, training. Define green (favorable), yellow (unknown), red (unfavorable) for each. Upload it the same way.
